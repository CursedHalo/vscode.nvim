...
theme.load_syntax = function()
  ...
  local syntax = {
    ...
    -- IncSearch = { c.vscPink, c.vscBack, 'none', nil },
    ...
    Pmenu = { c.vscPopupFront, c.vscNone, 'none', nil },
    PmenuSel = {
    ...
    -- Search = { c.vscPink, c.vscBack, 'none', nil },
    ...
    BufferLineSeparator = { c.vscPurpleLight, c.Back, 'none', nil },
    BufferLineSeparatorSelected = { c.vscPurpleDark, c.Back, 'none', nil },
    BufferLineSeparatorVisible = { c.vscPurpleLight, c.Back, 'none', nil },

    BufferLineTab = { c.vscLineNumber, c.Back, 'none', nil },
    BufferLineTabSelected = { c.vscPurpleLight, c.Back, 'none', nil },
    BufferLineTabClose = { c.vscPurpleLight, c.Back, 'none', nil },
    ...
    DiagnosticUnderlineError = { nil, nil, 'underline', c.vscRed },
    DiagnosticUnderlineWarn = { nil, nil, 'underline', c.vscYellow },
    DiagnosticUnderlineInfo = { nil, nil, 'underline', c.vscBlue },
    DiagnosticUnderlineHint = { nil, nil, 'underline', c.vscBlue },
    ...
    -- LspReferenceText = { nil, isDark and c.vscNone or c.vscPopupHighlightLightBlue, 'none', nil },
    -- LspReferenceRead = { nil, isDark and c.vscNone or c.vscPopupHighlightLightBlue, 'none', nil },
    -- LspReferenceWrite = { nil, isDark and c.vscNone or c.vscPopupHighlightLightBlue, 'none', nil },
